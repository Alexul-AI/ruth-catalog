...
export const products: Product[] = [
  ...
  { id: 't-007', category: 'טארטלטים', name: 'טארטלט מיני עגול',   catalogNumber: '2',  sku: '002',   flavor: 'שוקו',   size: '70×30 מ"מ', packageQty: '400 י"ח', isSpecialOrder: true  },
  { id: 't-008', category: 'טארטלטים', name: 'טארטלט מיני עגול',   catalogNumber: '2',  sku: '02',    flavor: 'מלוח',   size: '70×30 מ"מ', packageQty: '400 י"ח', isSpecialOrder: false },
  { id: 't-009', category: 'טארטלטים', name: 'טארטלט מיני עגול',   catalogNumber: '2',  sku: '2',     flavor: 'מתוק',   size: '70×30 מ"מ', packageQty: '400 י"ח', isSpecialOrder: false },
  ...
  { id: 't-016', category: 'טארטלטים', name: 'טארטלט אישי פרח',   catalogNumber: '5', sku: '5',   flavor: 'מתוק',   size: '48×11 מ"מ', packageQty: '240 י"ח', isSpecialOrder: false },

  // ── טארטלטים פרימיום ────────────────────────────────────────────────
  { id: 't-017', category: 'טארטלטים', name: 'טארטלט פרימיום 300',   catalogNumber: '300',  sku: '00300',  flavor: 'שוקו',  size: '60×14 מ"מ',    packageQty: '150 י"ח', isSpecialOrder: false },
  { id: 't-018', category: 'טארטלטים', name: 'טארטלט פרימיום 300',   catalogNumber: '300',  sku: '0300',   flavor: 'מלוח',  size: '60×14 מ"מ',    packageQty: '150 י"ח', isSpecialOrder: false },
  { id: 't-019', category: 'טארטלטים', name: 'טארטלט פרימיום 300',   catalogNumber: '300',  sku: '300',    flavor: 'מתוק',  size: '60×14 מ"מ',    packageQty: '150 י"ח', isSpecialOrder: false },
  ...
  { id: 't-026', category: 'טארטלטים', name: 'טארטלט פרימיום 600',   catalogNumber: '600',  sku: '00600',  flavor: 'שוקו',  size: '60/60×14 מ"מ', packageQty: '240 י"ח', isSpecialOrder: false },
  { id: 't-027', category: 'טארטלטים', name: 'טארטלט פרימיום 600',   catalogNumber: '600',  sku: '0600',   flavor: 'מלוח',  size: '60/60×14 מ"מ', packageQty: '240 י"ח', isSpecialOrder: false },
  { id: 't-028', category: 'טארטלטים', name: 'טארטלט פרימיום 600',   catalogNumber: '600',  sku: '600',    flavor: 'מתוק',  size: '60/60×14 מ"מ', packageQty: '240 י"ח', isSpecialOrder: false },

  // ── טארט כפרי ───────────────────────────────────────────────────────
  { id: 't-029', category: 'טארטלטים', name: 'טארט כפרי',        catalogNumber: '044',  sku: '044',  flavor: 'ניטרלי', size: '48×16 מ"מ', packageQty: '240 י"ח', isSpecialOrder: true },
  { id: 't-030', category: 'טארטלטים', name: 'טארט כפרי ירוק',   catalogNumber: '0442', sku: '0442', flavor: 'ניטרלי', size: '48×16 מ"מ', packageQty: '240 י"ח', isSpecialOrder: true },
  { id: 't-031', category: 'טארטלטים', name: 'טארט כפרי ורוד',   catalogNumber: '0443', sku: '0443', flavor: 'ניטרלי', size: '48×16 מ"מ', packageQty: '240 י"ח', isSpecialOrder: true },

  // ── פאיים (was בסיסי פאי) ─────────────────────────────────────────────
  { id: 'p-001', category: 'פאיים', name: 'בסיס פאי עגול',    catalogNumber: '8',  sku: '008', flavor: 'שוקו',  size: '90×14 מ"מ',  packageQty: '80 י"ח',  isSpecialOrder: true  },
  { id: 'p-002', category: 'פאיים', name: 'בסיס פאי עגול',    catalogNumber: '8',  sku: '08',  flavor: 'מלוח',  size: '90×14 מ"מ',  packageQty: '80 י"ח',  isSpecialOrder: false },
  { id: 'p-003', category: 'פאיים', name: 'בסיס פאי עגול',    catalogNumber: '8',  sku: '8',   flavor: 'מתוק',  size: '90×14 מ"מ',  packageQty: '80 י"ח',  isSpecialOrder: false },
  { id: 'p-004', category: 'פאיים', name: 'בסיס פאי בינוני',  catalogNumber: '12', sku: '012', flavor: 'מלוח',  size: '120×16 מ"מ', packageQty: '64 י"ח',  isSpecialOrder: false },
  ...
  { id: 'w-002', category: 'מאפים', name: 'גליליות וופל (ג\'וני)', catalogNumber: '—', sku: '254',  flavor: 'מתוק',   size: '55×25 מ"מ',    packageQty: '290 י"ח', isSpecialOrder: false },
  { id: 'w-003', category: 'מאפים', name: 'פחזניות למילוי',         catalogNumber: '—', sku: '31',   flavor: 'ניטרלי', size: 'קוטר 50 מ"מ',  packageQty: '120 י"ח', isSpecialOrder: false, storageTemp: '-18°' },
  ...
  { id: 'w-005', category: 'מאפים', name: 'מיני וופל בלגי',         catalogNumber: '—', sku: '1001', flavor: 'מתוק',   size: '60×20 מ"מ',    packageQty: '150 י"ח', isSpecialOrder: true  },

  // ── מקרונים למילוי (was בסיסי מקרון) ──────────────────────────────────
  { id: 'm-001', category: 'מקרונים למילוי', name: 'בסיס מקרון בינוני', catalogNumber: '—', sku: '—', flavor: 'ניטרלי (ללא צבע מאכל)', size: '45 מ"מ', packageQty: '240 י"ח', isSpecialOrder: false },
  { id: 'm-002', category: 'מקרונים למילוי', name: 'בסיס מקרון קטן',    catalogNumber: '—', sku: '—', flavor: 'ניטרלי (ללא צבע מאכל)', size: '30 מ"מ', packageQty: '400 י"ח', isSpecialOrder: false },
  ...
  // ── מרנגים (was מרנג) ──────────────────────────────────────────────────
  { id: 'mr-001', category: 'מרנגים', name: 'נשיקות מרנג',   catalogNumber: '—', sku: '—',    flavor: 'לבן', size: 'קוטר 20 מ"מ', packageQty: '16 י"ח',  isSpecialOrder: false },
  ...
  { id: 'f-001', category: 'קינוחים מוכנים', name: 'פחזניות קרמבל חום',               catalogNumber: '—', sku: '0305ז', flavor: 'שוקולד',    size: '45×30 מ"מ', packageQty: '120 י"ח', isSpecialOrder: false },
  { id: 'f-002', category: 'קינוחים מוכנים', name: 'פחזניות קרמבל סגול',              catalogNumber: '—', sku: '0309ז', flavor: 'קרם וניל',  size: '45×30 מ"מ', packageQty: '120 י"ח', isSpecialOrder: false },
  { id: 'f-003', category: 'קינוחים מוכנים', name: 'פחזניות קרמבל אדום',              catalogNumber: '—', sku: '0305ז', flavor: 'קרם וניל',  size: '45×30 מ"מ', packageQty: '120 י"ח', isSpecialOrder: false },
  { id: 'f-004', category: 'קינוחים מוכנים', name: 'פחזניות קרמבל לבן',               catalogNumber: '—', sku: '0305ז', flavor: 'קרם וניל',  size: '45×30 מ"מ', packageQty: '120 י"ח', isSpecialOrder: false },
  ...
  { id: 'f-008', category: 'קינוחים מוכנים', name: 'כדורי שוקולד בציפוי קוקוס',      catalogNumber: '—', sku: '6611',  flavor: 'קוקוס',     size: '—',         packageQty: '300 י"ח',         isSpecialOrder: false },
  { id: 'f-009', category: 'קינוחים מוכנים', name: 'כדורי שוקולד בציפוי סוכריות',    catalogNumber: '—', sku: '6622',  flavor: 'סוכריות',   size: '—',         packageQty: '300 י"ח',         isSpecialOrder: false },
